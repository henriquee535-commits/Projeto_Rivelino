...
if menu == "📊 Consulta":
    ...
    # Header de Consulta com apenas 1 logo alinhada
...
# ==========================================
    ...
    # Aba agora liberada, sem necessidade de senha
...
# ==========================================
    ...
    # Aba liberada sem necessidade de senha
...
# ==========================================
    ...
    # Aba agora com exigência de senha
    ...
    if senha in (SENHA_ACESSO, SENHA_ZERAR_ESTOQUE):
        ...
        if df_fin.empty:
            ...
            # Repensado o layout: De 6 colunas para 2 linhas com 3 colunas para leitura otimizada no Desktop/Mobile
